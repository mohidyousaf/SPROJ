        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              Text('NewsFeed', style: GoogleFonts.lato(textStyle: TextStyle(color: Color.fromRGBO(P_C_red, P_C_green, P_C_blue, 1.0),fontSize: 30)))
            ],
          ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  TabBar(
                    indicatorColor: Color.fromRGBO(S_C_red, S_C_green, S_C_blue, 0.5),
                    labelColor: Color.fromRGBO(P_C_red, P_C_green, P_C_blue, 1.0),
                      tabs: [
                        Tab(icon: Icon(feed),),

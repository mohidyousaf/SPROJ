...
1. Research for rescue system design
2. Register User
3. Delete Product
4. User MarketPlace
...
17. Cart functionality in marketplace
18. Checkout functionality in marketplace
20. Design for Rescue
21. Adding New rescue request
22. Google Maps API integration
23. Getting current user location
24. Integrating Google Places API integration to get geolocations
25. Integrating Google Distances API to get distances between places
26. User Shopping History Section in Profile
27. User Post History option in Profile

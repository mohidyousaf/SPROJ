...
class ShelterPetPage extends StatefulWidget {
  final PetInfo pet;
  const ShelterPetPage({ Key key, this.pet}) : super(key: key);

  @override
  State<ShelterPetPage> createState() => _ShelterPetPageState();
}

class _ShelterPetPageState extends State<ShelterPetPage> {
